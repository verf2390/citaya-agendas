...
export function FaqCtaSection() {
  return (
    <section className="px-4 pb-16 pt-4 sm:px-6 sm:pb-20 sm:pt-6 lg:px-10 lg:pb-24 lg:pt-8">
      <div className="mx-auto grid w-full max-w-6xl gap-10">
        <div>
          ...
          <div className="mt-6 space-y-3 sm:mt-8">
            {faqs.map((faq) => (
              <details key={faq.question} className="group rounded-2xl border border-slate-200 bg-white p-4 sm:p-5">
