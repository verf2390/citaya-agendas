...
export default function AdminFacturacionPage() {
  ...
  const buildPrintDocumentFromLab = () => {
    ...
    return {
      ...
      issuer: {
        tenantId,
        rut: settings.taxId || dteLabResult?.metadata.rutEmisor || "",
        legalName: settings.legalName || "",
        businessActivity: settings.businessActivity || "",
        address: settings.taxAddress || "",
        commune: settings.taxCommune || "",
        city: settings.taxCity || "",
        dteEnvironment: "lab" as const,
      },
      recipient: {
        rut: dteLabResult?.metadata.rutReceptor || "",
        legalName: "Receptor de prueba",
      ...
      lines: [
        {
          name: "Muestra técnica del tenant",
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <label className="grid gap-1 text-sm font-bold text-slate-700 sm:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="Ej: Empresa Servicios SpA"
                  />
                </label>
                <label className="grid gap-1 text-sm font-bold text-slate-700">
                  RUT empresa
