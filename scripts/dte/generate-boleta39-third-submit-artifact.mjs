...
const newCafPath = "/home/verf/secure/dte-lab/caf/FoliosSII7819564539112026832228.xml";
...
if (parsedNewCaf.rangeFrom !== 11 || parsedNewCaf.rangeTo !== 15) {
...
console.log(`Generating boleta 39 third submit (folios 11-15) artifacts in ${resolvedTargetDir}...`);
const realResult = await prepareRealBoleta39Certification(generationInput);

const generatedEnvelopePath = join(resolvedTargetDir, "EnvioBOLETA-39-CASO-11-15-CERTIFICATION.xml");
...
const rcofPath = join(resolvedTargetDir, "RCOF-39-FOLIOS-11-15-CERTIFICATION.xml");
...
const report = {
  ...
  outputDir: resolvedTargetDir,
  envelopeFilename: "EnvioBOLETA-39-CASO-11-15-CERTIFICATION.xml",
  envelopePath: generatedEnvelopePath,
  envelopeSha256: xmlSha256,
  rcofFilename: "RCOF-39-FOLIOS-11-15-CERTIFICATION.xml",
  rcofPath,
  rcofSha256,
  folios: [6, 7, 8, 9, 10],
  caseMapping: {
...
const shaSumsLines = [
  `${xmlSha256}  EnvioBOLETA-39-CASO-11-15-CERTIFICATION.xml`,
  `${rcofSha256}  RCOF-39-FOLIOS-11-15-CERTIFICATION.xml`,
];
for (let f = 6; f <= 10; f++) {
